"""
Handles writing process output into GPKG files.
...
METADATA = {"driver_name": "GPKG", "data_type": "vector", "mode": "rw"}


class OutputDataReader(_fiona_base.OutputDataReader):
    """
    Output reader class for GPKG.
    ...
    file_extension : string
        file extension for output files (.gpkg)
    output_params : dictionary
        output parameters from Mapchete file
    pixelbuffer : integer
