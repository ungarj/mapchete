...
from mapchete.io import (
    get_best_zoom_level, path_exists, absolute_path, read_json, tile_to_zoom_level, path
)
...
def test_read_remote_json(s3_metadata_json, http_metadata_json):
    ...
    with pytest.raises(FileNotFoundError):
        read_json("https://ungarj.github.io/tiled_data/raster/cleantopo/invalid_metadata.json")
